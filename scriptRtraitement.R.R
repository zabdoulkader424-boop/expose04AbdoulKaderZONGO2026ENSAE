...
# Sauvegarde du graphique de sensibilité
if (!dir.exists("Outputs/Graphics")) dir.create("Outputs/Graphics", recursive = TRUE)
ggsave("Outputs/Graphics/sensibilite.png", 
       width = 6,    # largeur
       height = 4,   # hauteur
       dpi = 150)
#==================================================================================
...
#====================================================================================
dossier_sortie <- "Outputs/Data_cleaned"
